            ...
            .children(vec![
                example_group_with_title(
                    ...
                    vec![
                        single_example(
                            "Default",
                            Vector::square(VectorName::AuracleLogo, size).into_any_element(),
                        ),
                        single_example(
                            "Custom Size",
                            h_flex()
                ...
                example_group_with_title(
                    ...
                    vec![
                        single_example(
                            "Accent Color",
                            Vector::square(VectorName::AuracleLogo, size)
                                .color(Color::Accent)
                                .into_any_element(),
                        ),
                        single_example(
                ...
                example_group_with_title(
                    ...
                    vec![single_example(
                        "Zed X Copilot",
                        Vector::square(VectorName::AuracleXCopilot, rems_from_px(100.))
                            .into_any_element(),
                    )],
                ),
            ])
...
mod tests {
    ...
    #[test]
    fn vector_path() {
        assert_eq!(VectorName::AuracleLogo.path().as_ref(), "images/auracle_logo.svg");
    }
}
