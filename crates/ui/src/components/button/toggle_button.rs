                ...
                vec![
                    ...
                    single_example(
                        ...
                        ToggleButtonGroup::single_row(
                            ...
                            [
                                ToggleButtonWithIcon::new("First", IconName::AiAuracle, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Second", IconName::AiAuracle, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Third", IconName::AiAuracle, |_, _, _| {}),
                            ],
                        )
                        .selected_index(1)
                        .into_any_element(),
                    ...
                    single_example(
                        ...
                        ToggleButtonGroup::two_rows(
                            ...
                            [
                                ToggleButtonWithIcon::new("Fourth", IconName::AiAuracle, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Fifth", IconName::AiAuracle, |_, _, _| {}),
                                ToggleButtonWithIcon::new("Sixth", IconName::AiAuracle, |_, _, _| {}),
                            ],
                        )
                        .selected_index(3)
                        .into_any_element(),
