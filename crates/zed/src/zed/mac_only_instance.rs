...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Auracle Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Auracle Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Auracle Editor Preview Instance Running",
        ReleaseChannel::Stable => "Auracle Editor Stable Instance Running",
    }
}
