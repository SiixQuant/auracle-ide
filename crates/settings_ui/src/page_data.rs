...
fn developer_page(cx: &App) -> SettingsPage {
    ...
    items.push(SettingsPageItem::SettingItem(SettingItem {
        ...
        description: "Collect timing data for foreground and background executor tasks so they can be inspected via `auracle: open performance profiler`. May lead to increased memory usage.",
    ...
    fn general_settings_section(_cx: &App) -> Vec<SettingsPageItem> {
        vec![
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "How `auracle <path>` opens directories when no flag is specified.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn security_section() -> [SettingsPageItem; 2] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "When opening Auracle, avoid Restricted Mode by auto-trusting all projects, enabling use of all features without having to give permission to each new project.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn workspace_restoration_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "What to restore from the previous session when opening Auracle.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn scoped_settings_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Which settings should be activated only in Preview build of Auracle.",
                field: Box::new(
                    SettingField {
                        organization_override: None,
    ...
    fn privacy_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Send anonymized usage data like what languages you're using Auracle with.",
                field: Box::new(SettingField {
                    organization_override: None,
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    files: USER,
                    title: "Icon Theme",
                    description: "The custom set of icons Auracle will associate with files and directories.",
                    field: Box::new(SettingField {
                        organization_override: None,
    ...
    fn file_scan_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be excluded by Auracle entirely. They will be skipped during file scans, file searches, and not be displayed in the project file tree. Takes precedence over \"File Scan Inclusions\"",
                field: Box::new(
                    SettingField {
                        organization_override: None,
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Files or globs of files that will be included by Auracle, even when ignored by git. This is useful for files that are not tracked by git, but are still important to your project. Note that globs that are overly broad can slow down Auracle's file scanning. \"File Scan Exclusions\" takes precedence over these inclusions",
                field: Box::new(
                    SettingField {
                        organization_override: None,
    ...
    fn window_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "(Linux only) whether Auracle or your compositor should draw window decorations.",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn general_section() -> [SettingsPageItem; 6] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether breakpoints should be reused across Auracle sessions.",
                field: Box::new(SettingField {
                    organization_override: None,
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to log messages between active debug adapters and Auracle.",
                field: Box::new(SettingField {
                    organization_override: None,
        ...
        [
            ...
            SettingsPageItem::DynamicItem(DynamicItem {
                discriminant: SettingItem {
                    ...
                    description: "Disable all Git integration features in Auracle.",
                    field: Box::new(SettingField::<bool> {
                        organization_override: None,
...
fn ai_page() -> SettingsPage {
    fn general_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Disable AI",
                description: "Whether to disable all AI features in Auracle.",
                field: Box::new(SettingField {
                    organization_override: None,
...
fn network_page() -> SettingsPage {
    fn network_section() -> [SettingsPageItem; 3] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Server URL",
                description: "The URL of the Auracle server to connect to.",
                field: Box::new(SettingField {
                    organization_override: None,
                ...
                metadata: Some(Box::new(SettingsFieldMetadata {
                    placeholder: Some("https://ide.aurapointcapital.com"),
                    ..Default::default()
                })),
                files: USER,
            }),
...
fn language_settings_data() -> Box<[SettingsPageItem]> {
    ...
    fn autoclose_section() -> [SettingsPageItem; 5] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Use Autoclose",
                description: "Whether to automatically type closing characters for you. For example, when you type '(', Auracle will automatically add a closing ')' at the correct position.",
                field: Box::new(SettingField {
                    organization_override: None,
            ...
            SettingsPageItem::SettingItem(SettingItem {
                ...
                description: "Whether to automatically surround text with characters for you. For example, when you select text and type '(', Auracle will automatically surround text with ().",
                field: Box::new(SettingField {
                    organization_override: None,
    ...
    fn tasks_section() -> [SettingsPageItem; 4] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Prefer LSP",
                description: "Use LSP tasks over Auracle language extension tasks.",
                field: Box::new(SettingField {
                    organization_override: None,
...
fn edit_prediction_language_settings_section() -> [SettingsPageItem; 5] {
    [
        ...
        SettingsPageItem::SettingItem(SettingItem {
            ...
            description: "Controls whether Auracle may collect training data when using Auracle's Edit Predictions. Data is only collected for files in projects detected as open source. The default value uses the preference previously set via the status-bar toggle, or false if no preference has been stored.",
            field: Box::new(SettingField {
