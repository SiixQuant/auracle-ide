        ...
        let result = h_flex()
            ...
            .when(!has_keybind, |el| {
                ...
                el.bg(status_colors.error_background)
                    .border_color(status_colors.error.opacity(0.6))
                    .pl_2()
                    .child(Icon::new(IconName::AuraclePredictError).color(Color::Error))
                    .cursor_default()
                    .hoverable_tooltip(move |_window, cx| {
                        cx.new(|_| MissingEditPredictionKeybindingTooltip).into()
                    })
                ...
                h_flex()
                    ...
                    .child(
                        h_flex()
                            .flex_1()
                            .gap_2()
                            .child(Icon::new(IconName::AuraclePredict))
                        ...
                        h_flex()
                            ...
                            .child(div().px_1p5().child(match &prediction.completion {
                                InlineCompletion::Move { target, snapshot } => {
                                    ...
                                    {
                                        Icon::new(IconName::AuraclePredictDown)
                                    } else {
                                        Icon::new(IconName::AuraclePredictUp)
                                    }
                                }
                                InlineCompletion::Edit { .. } => Icon::new(IconName::AuraclePredict),
                            }))
                            .child(
                                h_flex()
                                    .gap_1()
        ...
        match &completion.completion {
            ...
            InlineCompletion::Edit {
                ...
                let left = if first_edit_row != cursor_point.row {
                    ...
                    Icon::new(IconName::AuraclePredict).into_any_element()
                };
